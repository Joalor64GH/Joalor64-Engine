...
function onCreate()
    makeLuaText('songText', songName .. " " .. currentDifficulty .. " - Joalor64 Engine V1.4.0b-HOTFIX", 0, 2, 701);
...
function onUpdate(elapsed)
    ...
    setTextString('songText', songName .. " " .. currentDifficulty .. " - Joalor64 Engine V1.4.0b-HOTFIX");
end
