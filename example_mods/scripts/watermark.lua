...
function onCreate()
    makeLuaText('songText', songName .. " " .. currentDifficulty .. " - Joalor64 Engine V1.0.0e-beta", 0, 2, 701);
...
function onUpdate(elapsed)
    ...
    setTextString('songText', songName .. " " .. currentDifficulty .. " - Joalor64 Engine V1.0.0e-beta");
end
