...
function onCreate()
    makeLuaText('songText', songName .. " " .. currentDifficulty .. " - Joalor64 Engine V1.1.0", 0, 2, 701);
...
function onUpdate(elapsed)
    ...
    setTextString('songText', songName .. " " .. currentDifficulty .. " - Joalor64 Engine V1.1.0");
end
