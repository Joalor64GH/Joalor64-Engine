...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var pisspoop:Array<Array<String>> = [ //Name - Icon name - Description - Link - BG Color
			...
			['notweuz',             'weuz',             'OS Engine Code\nBeta Stage Editor',                       		'https://github.com/notweuz',          '940EEB'],
			...
			['stevecodedev',             'mag',             'Stage Editor\nPython Support\nCustom State Support',                       		'https://github.com/stevecodedev',          '0000FF'],
			...
			['Yoshubs',				'shubs',			'Additional Programmer of Psych Engine\nEpic Input System\nOG Forever Assets Manager',					'https://twitter.com/yoshubs',			'279ADC'],
			[''],
