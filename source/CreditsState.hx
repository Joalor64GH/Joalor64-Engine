	...
	override function create()
	{
		...
		var pisspoop:Array<Array<String>> = [ //Name - Icon name - Description - Link - BG Color
			...
			['weuz_',             'weuz',             'OS Engine Code',                       		'https://github.com/notweuz',          '940EEB'],
                        ['sayofthelor',             'lor',             'Crash Dialogue for Mac',                       		'https://twitter.com/sayofthelor',          'FFAB94'],
			...
			['gedehari',			'gedehari',			'Chart Editor\'s Sound Waveform base\nCrash Dialogue Code',						'https://twitter.com/gedehari',			'FF9300'],
