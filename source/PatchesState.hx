...
class PatchesState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var pisspoop:Array<Array<String>> = [ //Patch - Icon name - Changelog - Link to Version - BG Color
			['Patch Notes'], 
			['V1.5.2',         'life',             'Fixes for Flixel 5.3, Update SScript to 4.0.0,\nFormatted a few files, Song Display Option,\nAnd a little more.',                                  		'https://github.com/Joalor64GH/Joalor64-Engine/releases/tag/v1.5.2',  'FF66CF'],
