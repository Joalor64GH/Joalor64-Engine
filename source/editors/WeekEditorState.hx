...
class WeekEditorState extends MusicBeatState
{
	...
	function addOtherUI() {
		...
		tab_group.add(new FlxText(difficultiesInputText.x, difficultiesInputText.y + 20, 0, 'Default difficulties are "Noob, Easy, Normal,\nHard, Expert, Insane" without quotes.'));
